define(['base/js/namespace', 'base/js/events', 'notebook/js/textcell', 'notebook/js/codecell'], function (Jupyter, events, textcell, codecell) {
    ...
    */
    ...
    var initialize = function () {
        ...
        $.extend(true, params, Jupyter.notebook.config.data.extensionsample);
        ...
        update_params();
        var keys = [];
        console.log("SOLUTION"+params['extensionsample_solution'])
        for (_typ of typs){
            if (params[_typ]) {
